...
def average_association_time (folder_name):
    """Get the average association time from a list of sample files"""
    """Change the path for a different user"""
...
def rename_file ():
    ...
    i = 1
    while os.path.isfile('/home/mmmorfa/contiki-ng/examples/6tisch/pruebaZ1/Testlogs/w/COOJA_' + '{}.testlog'.format(str(i))):
        os.rename('/home/mmmorfa/contiki-ng/examples/6tisch/pruebaZ1/Testlogs/w/COOJA_' + '{}.testlog'.format(str(i)) , '/home/mmmorfa/contiki-ng/examples/6tisch/pruebaZ1/Testlogs/COOJA_' + '{}.testlog'.format(str(i+310)))
        i+=1
