...
def average_association_time (folder_name):
    ...
    while os.path.isfile('/home/mmmorfa/contiki-ng/examples/6tisch/simple-node/logs/' + folder_name + '/log_2_' + '{}.txt'.format(str(i))):
        a, b = get_association_time_txt('/home/mmmorfa/contiki-ng/examples/6tisch/simple-node/logs/' + folder_name + '/' + 'log_2_'+ '{}.txt'.format(str(i)))
        time_list.append(a)
        EB_list.append(b)
        i+=1
...
def rename_file ():
    ...
    i = 1
    while os.path.isfile('/home/mmmorfa/contiki-ng/examples/6tisch/simple-node/logs/log_2_' + '{}.txt'.format(str(i))):
        os.rename('/home/mmmorfa/contiki-ng/examples/6tisch/simple-node/logs/log_2_' + '{}.txt'.format(str(i)) , '/home/mmmorfa/contiki-ng/examples/6tisch/simple-node/logs/log_2_' + '{}.txt'.format(str(i+457)))
        i+=1
